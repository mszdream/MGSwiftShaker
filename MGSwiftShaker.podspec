#
# Be sure to run `pod lib lint MGSwiftShaker.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/mszdream/MGSwiftShaker'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mszdream' => 'mszdream@126.com' }
  s.source           = { :git => 'https://github.com/mszdream/MGSwiftShaker.git', :tag => s.version.to_s }
